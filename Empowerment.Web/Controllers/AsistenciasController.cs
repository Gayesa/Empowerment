...
namespace Empowerment.Web.Controllers
{
    ...
    public class AsistenciasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Usuario,FechaEntrada,FechaSalida")] Asistencia asistencia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Usuario,FechaEntrada,FechaSalida")] Asistencia asistencia)
        {
            if (id != asistencia.Id)
            {
                return NotFound();
