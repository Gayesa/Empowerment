...
namespace Empowerment.Web.Controllers
{
    public class AgendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Comentarios,Disponibilidad")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Comentarios,Disponibilidad")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
