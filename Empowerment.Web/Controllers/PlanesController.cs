...
namespace Empowerment.Web.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Categoria,Sigla,Sesiones,Costo,Descripcion")] Plan plan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Categoria,Sigla,Sesiones,Costo,Descripcion")] Plan plan)
        {
            if (id != plan.Id)
            {
                return NotFound();
