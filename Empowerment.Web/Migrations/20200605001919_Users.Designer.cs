...
namespace Empowerment.Web.Migrations
{
    ...
    [Migration("20200605001919_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Empowerment.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Empowerment.Web.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("Empowerment.Web.Data.Entities.Cliente", b =>
                {
                    b.HasOne("Empowerment.Web.Data.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Empowerment.Web.Data.Entities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
